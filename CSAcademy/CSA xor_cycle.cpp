/*
    ...
    meaning our problem is just to find max xor subset of those numbers

    full editorial: https://csacademy.com/contest/archive/task/xor_cycle/solution/
...
ll gauss(){
    ...
    ll ret=0;
    for(int i=1;i<=maxbit+1;i++)ret^=niz[i];
